        ...
        <div class="mx-auto max-w-4xl">
          <div class="">
            ...
            <div class="flex items-center pt-5 md:pt-10">
              <div>
                <img src= {builder.image(profile.image)}
                  class="h-20 w-20 rounded-full border-2 border-grey-70 shadow"
                  alt="author image" />
              </div>
              <div class="pl-5">
                <span class="block font-body text-xl font-bold text-grey-10">By {profile.name}</span>
                <span class="block pt-1 font-body text-xl font-bold text-grey-30">F{blog.createdAt}</span>
              </div>
            </div>
          </div>
